...
M.globalkeys = gears.table.join(
	...
	awful.key({ config.modkey }, "w", function()
		topbar.mymainmenu:show()
	end, { description = "show main menu", group = "awesome" }),
	awful.key({ config.modkey, "Control" }, "p", function()
		xrandr.xrandr()
	end, { description = "Configure Monitors", group = "awesome" }),
	...
	-- Standard program
	awful.key({ config.modkey, "Shift" }, "Return", function()
		awful.spawn(config.terminal)
	end, { description = "open a terminal", group = "launcher" }),
	awful.key({ config.modkey, "Shift" }, "b", function()
...
M.clientkeys = gears.table.join(
	...
	awful.key({ config.modkey }, "Return", function(c)
